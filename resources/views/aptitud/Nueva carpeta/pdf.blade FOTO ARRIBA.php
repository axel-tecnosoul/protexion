    ...
    <div id="content" class="container">
      ...
      <?php
              if($voucher->paciente->imagen){
                // Ruta de la imagen
                $imagen = 'imagenes/paciente/'.$voucher->paciente->imagen;?>
                <img src="{{ asset($imagen)}}" width="75px" class="" alt="User Image">
                <!-- <img src="{{ asset($imagen)}}" style="rotate: none;" width="75px" class="" alt="User Image"> -->
                <?php
              }?>
