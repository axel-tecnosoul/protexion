...
<body>
    ...
    <div id="content" class="container">
      ...
      <table class="table table-condensed table-hover" >
        <tr>
          <td style="text-align: center; background-color: brown; color: #FFFFFF" colspan="6">DATOS DE LA EMPRESA</td>
          <td style="text-align: center; background-color: brown; color: #FFFFFF" colspan="6">INFORME FINAL EXAMENES PREOCUPACIONALES</td>
        </tr>
        <tr style="text-align: left;">
          <td style=" width: 250px" colspan="6">
          ...
          <td style="text-align: center;" rowspan="3" colspan="2"><?php
              if($voucher->paciente->imagen){
                ...
                <img src="<?=$nombreImagen?>" width="75px" style="margin:0" alt="User Image"><?php
              }?>
          </td>
        </tr>
        <tr style="text-align: left;">
