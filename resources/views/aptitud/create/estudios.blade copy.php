                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-2">
                                    <div class="icheck-danger d-inline">
                                        <input class="radioObsPre" data-target="observaciones" type="radio" name="POinput_{{$i}}_{{$j}}_radio" id="POinput_{{$i}}_{{$j}}_check_obs" value="O" <?=$checkedObs?>>
                                        <label for="POinput_{{$i}}_{{$j}}_check_obs">Obs</label>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="icheck-danger d-inline">
                                        <input class="radioObsPre" data-target="preexistencias" type="radio" name="POinput_{{$i}}_{{$j}}_radio" id="POinput_{{$i}}_{{$j}}_check_pre" value="P" <?=$checkedPre?>>
                                        <label for="POinput_{{$i}}_{{$j}}_check_pre">Pre</label>
                                    </div>
