...
$hosting = config('database.connections.mysql.host');*/
...
define("CHARSET", 'utf8');
define("CREATE_DATABASE_IF_NOT_EXISTS", false);
...
/**
* Tablas ignoradas. En versiones de PHP que soporten constantes como array debería ir al inicio
*/
/*$IGNORE_TABLES=array(
	'tbl_token_auth',
	'token_auth'
...
$nombreDelArchivo=$backupDatabase->getBackupFile();
...
var_dump($backupDatabase->getBackupFile());*/
...
document.addEventListener('DOMContentLoaded',function(){//DOMContentLoaded se dispara cuando se carga el dom, sin tener en cuenta hojas de estilos o imagenes
	window.open("<?="../".$nombreDelArchivo?>","_blank");
},false);
