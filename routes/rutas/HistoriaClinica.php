...
Route::get('historia_clinica', 'HistoriaClinicaController@index')->name('historia_clinica.index');
...
Route::get('historia_clinica/{historia_clinica}/hc_formulario', 'HcFormularioController@index')->name('hc_formulario.index');
//CREAR FORMULARIO DE FORMULARIO DE HISTORIA CLINICA
Route::get('historia_clinica/{historia_clinica}/create', 'HcFormularioController@create')->name('hc_formulario.create');
Route::post('hc_formulario', 'HcFormularioController@store')->name('hc_formulario.store');
?>
